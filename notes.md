...
- [ModelAdmin.fieldsets](https://docs.djangoproject.com/en/5.1/ref/contrib/admin/#django.contrib.admin.ModelAdmin.fieldsets) - control admin layout sections. other objects like `fields` can control layout order, build `inlines` forms for related objects, etc.
